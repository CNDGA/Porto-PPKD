...
include "koneksi.php";
		...
		if (isset($_POST['simpan'])) {
			...
			$cekEmail= mysqli_query($a, "SELECT email FROM contact WHERE email = '$email'");
			...
			if ($rowEmail) {
				...
				$insert = mysqli_query($a, "INSERT INTO contact (nama, email, subjek, pesan) VALUES ('$nama', '$email', '$subjek','$pesan')");
				if ($insert) {
		...
		$rowResume=mysqli_fetch_all($resume, MYSQLI_ASSOC);
		
		$selectAbout= mysqli_query($a,"SELECT * FROM setting WHERE id=1");
		$rowAbout= mysqli_fetch_assoc($selectAbout);
		// var_dump($rowAbout);

		$projects=mysqli_query($a, "SELECT *FROM project ORDER BY id DESC");
...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
	      ...
	      <div class="slider-item ">
	        ...
	        <div class="container">
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
	          	<div class="one-third js-fullheight order-md-last img" style="background-image:url(assets/fe/images/bg_1.png);">
	          		<div class="overlay"></div>
	          	</div>
	      ...
	      <div class="slider-item">
	        ...
	        <div class="container">
	          <div class="row d-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
	          	<div class="one-third js-fullheight order-md-last img" style="background-image:url(assets/fe/images/bg_2.png);">
	          		<div class="overlay"></div>
	          	</div>
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
      ...
      <div class="container">
        ...
        <div class="row d-flex">
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <a href="single.html" class="block-20" style="background-image: url('assets/fe/images/image_1.jpg');">
              </a>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
              <a href="single.html" class="block-20" style="background-image: url('assets/fe/images/image_2.jpg');">
              </a>
              <div class="text mt-3 float-right d-block">
              	<div class="d-flex align-items-center mb-3 meta">
	                <p class="mb-0">
          ...
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <a href="single.html" class="block-20" style="background-image: url('assets/fe/images/image_3.jpg');">
              </a>
              <div class="text mt-3 float-right d-block">
              	<div class="d-flex align-items-center mb-3 meta">
	                <p class="mb-0">
    ...
    <section class="ftco-section ftco-hireme img margin-top" style="background-image: url(assets/fe/images/bg_1.jpg)">
			<div class="container">
      ...
      <div class="container">
        ...
        <div class="row no-gutters block-9">
          <div class="col-md-6 order-md-last d-flex">
						...
						<!-- <?php
						if (isset($_GET['contact']) && $_GET['contact'] == 'berhasil' ) {
						?>
            ...
            <form action="" class="bg-light p-4 p-md-5 contact-form" method="POST" require>
              <div class="form-group">
                <input type="text" name="nama" class="form-control" placeholder="Your Name" require>
              </div>
              <div class="form-group">
                <input type="email" name="email" class="form-control" placeholder="Your Email" require>
              </div>
              <div class="form-group">
                <input type="text" class="form-control" placeholder="Subject" name="subjek" require>
              </div>
              <div class="form-group">
                <textarea cols="30" rows="7" class="form-control" placeholder="Message" name="pesan" require></textarea>
              </div>
              <div class="form-group">
                <input type="submit" name="simpan" value="Send Message" class="btn btn-primary py-3 px-5">
              </div>
            </form>
          ...
          <div class="col-md-6 d-flex">
          	<div class="img" style="background-image: url(assets/fe/images/about.jpg);"></div>
          </div>
        </div>
      </div>
    </section>
