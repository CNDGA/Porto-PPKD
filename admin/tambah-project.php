...
if (isset($_POST['simpan'])) {
    ...
    if ($foto['error'] == 0) {
        ...
        $insert = mysqli_query($a, "INSERT INTO project (nama, kategori, foto) 
...
if (isset($_GET['edit'])) {
    $id = $_GET['edit'];
    $queryEdit = mysqli_query($a, "SELECT * FROM project WHERE id = $id");
...
if (isset($_POST['edit'])) {
    ...
    // print_r($fileName);
    // die;
    $q_Update = mysqli_query($a, "UPDATE project SET nama='$nama',
